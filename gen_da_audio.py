...
SEGMENTS = [
    ...
    ("speech",  "Har du to eller flere medicin på listen, viser Somalimed automatisk deres interaktioner og advarsler samlet — i lilla og rødt, så det er let at se forskel.", "mylist_interact"),
