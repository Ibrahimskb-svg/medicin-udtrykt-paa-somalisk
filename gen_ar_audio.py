...
SEGMENTS = [
    ...
    ("speech",  "إذا كان لديكم دواءان أو أكثر في القائمة، يعرض سوماليميد تلقائيًا تفاعلاتهما وتحذيراتهما مجتمعة — باللونين البنفسجي والأحمر، لتتمكنوا من التمييز بسهولة.", "mylist_interact"),
