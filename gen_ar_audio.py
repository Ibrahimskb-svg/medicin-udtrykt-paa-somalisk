...
SEGMENTS = [
    # HERO
    (0,     12,    "مرحباً بكم في سوماليميد. في هذا الفيديو سنريكم كيفية استخدام الموقع خطوة بخطوة."),
    ...
    # STILHED — NAVIGATION TIL FORSIDEN
    (72,    75,    ""),

    # AFSLUTNING PÅ FORSIDEN
    (75,    88,    "سوماليميد يقدم معلومات طبية موثوقة مبنية على معرفة علمية متخصصة. يضم الموقع خمسة وعشرين دواءً شائعاً باللغات الأربع."),
