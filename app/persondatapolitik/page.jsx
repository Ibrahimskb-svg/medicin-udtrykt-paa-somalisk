  ...
  return (
    <main style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 24px 80px", fontFamily: "system-ui, sans-serif", color: "#1e293b", lineHeight: 1.8 }}>
      ...
      <Section title="Dataansvarlig">
        Ibrahim Dahir Hanaf er dataansvarlig for behandlingen af persondata på somalimed.dk. Kontakt: <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a>.
      </Section>

      <Section title="Hvilke data behandler vi, og hvorfor?">
        <DataTable headers={["Kilde", "Data", "Formål", "Opbevaring"]} rows={[
          ["Kontaktformular", "Navn, by, evt. e-mail og telefon", "For at kunne besvare din henvendelse, ros, ris eller forslag.", "Sendes direkte fra din egen e-mail-app til 197IDH@apoteket.dk. Gemmes ikke i en database på siden."],
      ...
      <Section title="Dine rettigheder">
        Du har ret til at få indsigt i, rettet eller slettet de data, vi har om dig, samt ret til at gøre indsigelse mod behandlingen. Kontakt <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a> for at gøre brug af dine rettigheder. Du kan også klage til Datatilsynet på <a href="https://www.datatilsynet.dk" target="_blank" rel="noopener noreferrer" style={{ color: "#0D9488", fontWeight: 600 }}>datatilsynet.dk</a>.
      </Section>

      <Section title="Kontakt">
        Har du spørgsmål til vores behandling af persondata, er du velkommen til at kontakte os via chat-funktionen på siden eller på <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a>.
      </Section>
      ...
      <Section title="Data controller">
        Ibrahim Dahir Hanaf is the data controller for personal data processed on somalimed.dk. Contact: <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a>.
      </Section>

      <Section title="What data do we process, and why?">
        <DataTable headers={["Source", "Data", "Purpose", "Storage"]} rows={[
          ["Contact form", "Name, city, optional email and phone", "So we can respond to your message, praise, criticism or suggestion.", "Sent directly from your own email app to 197IDH@apoteket.dk. Not stored in a database on the site."],
      ...
      <Section title="Your rights">
        You have the right to access, correct or delete the data we hold about you, and the right to object to the processing. Contact <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a> to exercise your rights. You can also file a complaint with the Danish Data Protection Agency at <a href="https://www.datatilsynet.dk" target="_blank" rel="noopener noreferrer" style={{ color: "#0D9488", fontWeight: 600 }}>datatilsynet.dk</a>.
      </Section>

      <Section title="Contact">
        If you have questions about our processing of personal data, you're welcome to contact us via the chat function on the site or at <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a>.
      </Section>
      ...
      <Section title="Ka mas'uulka xogta">
        Ibrahim Dahir Hanaf ayaa ah ka mas'uulka habaynta xogta shakhsiga ee somalimed.dk. La xiriir: <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a>.
      </Section>

      <Section title="Xogtee ayaan habeynaa, iyo sababta?">
        <DataTable headers={["Isha", "Xogta", "Ujeedka", "Kaydinta"]} rows={[
          ["Foomka xiriirka", "Magaca, magaalada, iimaylka iyo lambarka telefoonka haddii aad bixiso", "Si aan uga jawaabno fariintaada, ammaanta, dhaleeceynta ama soo jeedintaada.", "Waxaa laga soo diraa app-kaaga iimaylka si toos ah 197IDH@apoteket.dk. Kuma kaydsana database ku yaal bogga."],
      ...
      <Section title="Xuquuqdaada">
        Waxaad xaq u leedahay inaad aragto, saxdo ama tirtirto xogta aan ku haynay, iyo xaq u leh inaad ka soo horjeesato habaynta. La xiriir <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a> si aad u isticmaasho xuquuqdaada. Waxaad sidoo kale u caban kartaa Datatilsynet (Waaxda Ilaalinta Xogta Danish) ee <a href="https://www.datatilsynet.dk" target="_blank" rel="noopener noreferrer" style={{ color: "#0D9488", fontWeight: 600 }}>datatilsynet.dk</a>.
      </Section>

      <Section title="La xiriir">
        Haddii aad su'aalo ka qabto habaynta xogtaada shakhsiga, waad la xiriiri kartaa chatka bogga ama <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a>.
      </Section>
      ...
      <div dir="rtl">
        ...
        <Section title="المسؤول عن البيانات">
          إبراهيم ظاهر حنف هو المسؤول عن معالجة البيانات الشخصية على somalimed.dk. للتواصل: <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a>.
        </Section>

        <Section title="ما هي البيانات التي نعالجها، ولماذا؟">
          <DataTable headers={["المصدر", "البيانات", "الغرض", "التخزين"]} rows={[
            ["نموذج التواصل", "الاسم، المدينة، البريد الإلكتروني والهاتف (اختياري)", "للرد على رسالتك أو مدحك أو انتقادك أو اقتراحك.", "يُرسل مباشرة من تطبيق بريدك الإلكتروني إلى 197IDH@apoteket.dk. لا يُخزَّن في قاعدة بيانات على الموقع."],
        ...
        <Section title="حقوقك">
          يحق لك الاطلاع على البيانات التي نحتفظ بها عنك أو تصحيحها أو حذفها، ولك الحق في الاعتراض على المعالجة. تواصل عبر <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a> لممارسة حقوقك. يمكنك أيضًا تقديم شكوى إلى الهيئة الدنماركية لحماية البيانات عبر <a href="https://www.datatilsynet.dk" target="_blank" rel="noopener noreferrer" style={{ color: "#0D9488", fontWeight: 600 }}>datatilsynet.dk</a>.
        </Section>

        <Section title="التواصل">
          إذا كانت لديك أسئلة حول معالجتنا للبيانات الشخصية، فمرحبًا بتواصلك عبر خاصية الدردشة على الموقع أو عبر <a href="mailto:197IDH@apoteket.dk" style={{ color: "#0D9488", fontWeight: 600 }}>197IDH@apoteket.dk</a>.
        </Section>
      </div>
