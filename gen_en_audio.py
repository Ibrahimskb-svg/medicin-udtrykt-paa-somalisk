...
SEGMENTS = [
    ...
    ("speech",  "If you have two or more medicines on the list, Somalimed automatically shows their interactions and warnings together — in purple and red, so they're easy to tell apart.", "mylist_interact"),
