...
SEGMENTS = [
    ...
    ("speech",  "Haddii aad laba daawo ama in ka badan ku haysato liiska, Somalimed wuxuu si toos ah u muujiyaa isdhexgalka iyo digniinaha oo isku darsan, kala midab ah si aad si fudud ula kala saarto.", "mylist_interact"),
