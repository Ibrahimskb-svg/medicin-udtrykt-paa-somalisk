...
export const MEDICINE_ALIASES = {
  amlodipin: ["amlodipin", "norvasc", "istin", "amlodac", "amlor"],
  atorvastatin: ["atorvastatin", "lipitor", "torvast"],
  diclofenac: ["diclofenac", "voltaren", "cataflam", "diclomax", "motifene"],
  eliquis: ["eliquis", "apixaban"],
  enalapril: ["enalapril", "renitec", "vasotec"],
  hjertemagnyl: ["hjertemagnyl", "magnyl"],
  ibuprofen: ["ibuprofen", "ipren", "nurofen", "advil", "brufen", "motrin", "ibumetin"],
  insulin: ["insulin"],
  ...
  morfin_tablet: ["morfin", "dolcontin", "malfin", "ms contin", "oramorph"],
  morfin_injektion: ["morfin injektion", "morfin inj"],
  naproxen: ["naproxen", "naprosyn", "aleve"],
  pantoprazol: ["pantoprazol", "pantoloc", "protonix", "somac", "controloc"],
  paracetamol: ["paracetamol", "pinex", "panodil", "panadol", "tylenol", "acetaminophen", "calpol", "pamol"],
  ...
  zopiclon: ["zopiclon", "imozop", "zopiclone", "zimovane"],
};
