...
const TEXTS = {
  da: {
    ...
    symptomIntro: "Skriv det du mærker (f.eks. \"kvalme\" eller \"svimmelhed\"), så tjekker jeg om det allerede står som en kendt bivirkning på et af dine gemte medicin.",
  ...
  en: {
    ...
    symptomIntro: "Type what you're feeling (e.g. \"nausea\" or \"dizziness\"), and I'll check if it's already listed as a known side effect of one of your saved medicines.",
  ...
  ar: {
    ...
    symptomIntro: "اكتب ما تشعر به (مثلاً \"غثيان\" أو \"دوخة\")، وسأتحقق مما إذا كان مذكورًا بالفعل كعرض جانبي معروف لأحد أدويتك المحفوظة.",
