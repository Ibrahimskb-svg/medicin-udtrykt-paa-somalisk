...
// ── Nav tab labels — one per language, no mixing ───────────────────────────
const NAV_LABELS = {
...
// ── About Me — 100 % correct per language, zero mixing ────────────────────
const ABOUT_ME_DATA = {
  da: {
    name: "Ibrahim Dahir Hanaf",
    title: "Farmakonom & naturvidenskabelig formidler",
    bullets: [
      { icon: "🎓", text: "Bachelor i Kemi og Medicinalbiologi samt uddannet Farmakonom" },
      { icon: "💊", text: "Daglig praksis på privatapotek og vagtapotek" },
      { icon: "🌍", text: "Brobygger mellem faglig viden og mennesker med forskellig baggrund" },
      { icon: "❤️", text: "Brænder for klar, tryg og tilgængelig lægemiddelinformation" },
    ],
  },
  en: {
    name: "Ibrahim Dahir Hanaf",
    ...
    bullets: [
      { icon: "🎓", text: "Bachelor's degree in Chemistry & Medicinal Biology, trained Pharmaconomist" },
      { icon: "💊", text: "Daily practice in both community pharmacy and emergency pharmacy" },
      { icon: "🌍", text: "Bridge-builder between professional knowledge and diverse communities" },
      { icon: "❤️", text: "Passionate about clear, trustworthy and accessible medicine information" },
    ],
  },
  so: {
    ...
    bullets: [
      { icon: "🎓", text: "Shahaadada koowaad ee Kimiyada iyo Sayniska Dawooyinka, farsamaynta Farmakonom" },
      { icon: "💊", text: "Shaqo maalinleh oo ku saabsan farmashiyaha gaarka ah iyo farmashiyaha xaaladaha deg-dega ah" },
      { icon: "🌍", text: "Xiriir dhexdhexaadiye u dhexeeya aqoonta xirfadeed iyo bulshooyinka kala duwan" },
      { icon: "❤️", text: "Xiise weyn u qabo macluumaadka daawooyinka ee cad, la aamin karo oo u dhammaanba sahlan" },
    ],
  },
  ar: {
    ...
    bullets: [
      { icon: "🎓", text: "بكالوريوس في الكيمياء وعلم الأحياء الدوائي، وحاصل على تأهيل فارماكونوم" },
      { icon: "💊", text: "ممارسة يومية في الصيدلية الخاصة وصيدلية المناوبة" },
      { icon: "🌍", text: "جسر بين المعرفة المتخصصة والمجتمعات ذات الخلفيات المتنوعة" },
      { icon: "❤️", text: "شغف حقيقي بتقديم معلومات دوائية واضحة وموثوقة وسهلة الوصول للجميع" },
    ],
  },
};

// ── About Somalimed — 100 % correct per language ───────────────────────────
const ABOUT_SITE_DATA = {
  da: {
    tagline: "Lægemiddelinformation på dit eget sprog",
    bullets: [
      { icon: "📋", text: "25 nøje udvalgte lægemidler fra den daglige apotekspraksis" },
      { icon: "🗣️", text: "Tilgængelig på dansk, engelsk, somali og arabisk" },
      { icon: "🔬", text: "Fagligt funderet — skrevet af en uddannet Farmakonom" },
      { icon: "🚀", text: "Løbende udvidelse: antibiotika, antivirale midler, antihistaminer m.m." },
    ],
  },
  en: {
    tagline: "Medicine information in your own language",
    bullets: [
      { icon: "📋", text: "25 carefully selected medicines from everyday pharmacy practice" },
      { icon: "🗣️", text: "Available in Danish, English, Somali and Arabic" },
      { icon: "🔬", text: "Professionally grounded — written by a trained Pharmaconomist" },
      { icon: "🚀", text: "Continuously expanding: antibiotics, antivirals, antihistamines and more" },
    ],
  },
  so: {
    tagline: "Macluumaadka daawooyinka ee luqaddaada hooyo",
    bullets: [
      { icon: "📋", text: "25 daawo oo si taxaddar leh loo xushay shaqada maalinlaha ah ee farmashiyaha" },
      { icon: "🗣️", text: "Ku heli kartaa af-Soomaali, Ingiriisi, Dansk iyo Carabi" },
      { icon: "🔬", text: "Aasaas xirfadeed — oo qoray Farmakonom si dhab ah u tababaran" },
      { icon: "🚀", text: "Kor u qaadista joogtada ah: antibiyootikada, daawooyinka fayraska, antihistamiinnada iwm." },
    ],
  },
  ar: {
    tagline: "معلومات الدواء بلغتك الأم",
    bullets: [
      { icon: "📋", text: "25 دواءً مختاراً بعناية من الممارسة اليومية في الصيدلية" },
      { icon: "🗣️", text: "متاح باللغات الدنماركية والإنجليزية والصومالية والعربية" },
      { icon: "🔬", text: "أساس مهني متين — بقلم فارماكونوم مؤهل" },
      { icon: "🚀", text: "توسع مستمر: المضادات الحيوية، مضادات الفيروسات، مضادات الهيستامين وغيرها" },
    ],
  },
};
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <span style={{ fontSize: "22px" }}>{tab === "me" ? "👤" : "🌐"}</span>
          ...
          {tab === "me" ? (
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "10px" }}>
                {meData.bullets.map((b, i) => (
                  <li key={i} style={{
                    ...
                    <span style={{ fontSize: "24px", lineHeight: 1, flexShrink: 0, marginTop: "1px" }}>{b.icon}</span>
                    <span style={{ fontSize: "15px", color: "#1e293b", lineHeight: 1.65, fontWeight: 500 }}>
                      {b.text}
                    </span>
                  </li>
                ))}
            ...
            <>
              ...
              <div style={{
                ...
                marginBottom: "20px", border: "1px solid #99f6e4",
              }}>
                <p style={{ fontWeight: 700, fontSize: "16px", color: "#0f766e", margin: 0, textAlign: isRtl ? "right" : "left" }}>
                  🌐 {siteData.tagline}
                </p>
              </div>
    ...
    <div style={{ background: "var(--bg)", color: "var(--text)" }} className="min-h-screen">
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Right side: two tab buttons only */}
          <div style={{ display: "flex", gap: "8px" }}>
            <button
              type="button"
              onClick={() => setModalTab(modalTab === "me" ? null : "me")}
              style={{
                display: "inline-flex", alignItems: "center", gap: "7px",
                padding: "9px 18px", borderRadius: "999px",
                border: "1.5px solid",
                borderColor: modalTab === "me" ? "var(--accent, #0d9488)" : "#e2e8f0",
                background: modalTab === "me" ? "var(--accent, #0d9488)" : "#fff",
                color: modalTab === "me" ? "#fff" : "#334155",
                fontWeight: 600, fontSize: "14px", cursor: "pointer",
                transition: "all 0.2s", whiteSpace: "nowrap",
                boxShadow: modalTab === "me" ? "0 2px 12px rgba(13,148,136,0.28)" : "0 1px 3px rgba(0,0,0,0.06)",
              }}
            >
            ...
            <button
              type="button"
              onClick={() => setModalTab(modalTab === "site" ? null : "site")}
              style={{
                display: "inline-flex", alignItems: "center", gap: "7px",
                padding: "9px 18px", borderRadius: "999px",
                border: "1.5px solid",
                borderColor: modalTab === "site" ? "var(--accent, #0d9488)" : "#e2e8f0",
                background: modalTab === "site" ? "var(--accent, #0d9488)" : "#fff",
                color: modalTab === "site" ? "#fff" : "#334155",
                fontWeight: 600, fontSize: "14px", cursor: "pointer",
                transition: "all 0.2s", whiteSpace: "nowrap",
                boxShadow: modalTab === "site" ? "0 2px 12px rgba(13,148,136,0.28)" : "0 1px 3px rgba(0,0,0,0.06)",
              }}
            >
              <span style={{ fontSize: "15px" }}>🌐</span>
              {navLabels.aboutSite}
      ...
      {/* ── Hero — clean, no duplicate buttons ────────────────────────── */}
              ...
              return (
                ...
                >
                  <img
                    ...
                    alt=""
                    style={{ width: 22, height: 22, objectFit: "contain", flexShrink: 0, filter: isActive ? "brightness(0) invert(1)" : "none", mixBlendMode: isActive ? "normal" : "multiply" }}
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col p-5">
                      ...
                      <div className="mt-auto flex items-center justify-between border-t pt-4" style={{ borderColor: "var(--border)", marginTop: "1rem" }}>
                        ...
                        <span className="flex h-8 w-8 items-center justify-center rounded-full text-sm text-white transition duration-300 group-hover:scale-110" style={{ background: style.color }}>
                          →
                        </span>
                      </div>
                    </div>
      ...
      <footer className="mx-auto max-w-6xl px-4 pb-14 pt-4">
        <div className="rounded-3xl border bg-white px-6 py-6 shadow-sm" style={{ borderColor: "var(--border)" }}>
          <div className="flex items-start gap-4">
            <div style={{
              marginTop: "2px", display: "flex", height: 48, width: 48, flexShrink: 0,
              alignItems: "center", justifyContent: "center",
              borderRadius: "14px", background: "var(--bg)", color: "var(--accent)",
            }}>
              <ShieldInfoIcon />
            </div>
            <div className="min-w-0">
              <strong style={{ display: "block", fontSize: "16px", fontWeight: 700, color: "var(--text)" }}>
                {text.footerStrong}
              </strong>
              {text.footer1 && (
                <p style={{ marginTop: "10px", fontSize: "15px", lineHeight: "1.75", color: "var(--text-muted)" }}>
                  {text.footer1}
                </p>
              )}
              {text.footer3 && (
              ...
              {text.footer2 && (
                <p style={{ marginTop: "14px", fontSize: "15px", fontWeight: 600, color: "var(--text-muted)" }}>
                  {text.footer2}
                </p>
              )}
            </div>
