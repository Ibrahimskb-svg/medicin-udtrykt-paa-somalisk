...
const NAV_LABELS = {
  ...
  en: {
    aboutMe: "About me",
    aboutSite: "About Somalimed",
    faq: "FAQ",
    feedback: "Feedback",
    contact: "Contact",
  },
  so: {
    aboutMe: "Ku saabsan aniga",
    aboutSite: "Ku saabsan Somalimed",
    faq: "Su'aalaha",
    feedback: "Faallo",
    contact: "Xiriir",
  },
...
// ── Chat labels / helper bubble ────────────────────────────────────────────
const CHAT_PLUGIN_HINT = {
  da: {
    pill: "Chat med Ibrahim",
    small: "Klik på chatten nederst til højre",
  },
  en: {
    pill: "Chat with Ibrahim",
    small: "Click the chat in the bottom right",
  },
  so: {
  ...
  ar: {
    ...
    small: "اضغط على الدردشة أسفل اليمين",
  },
};
...
const LANG_THEME = {
  so: {
    ...
    soft: "#F0FDFA",
    border: "#99f6e4",
    tagBg: "linear-gradient(135deg,#f0fdfa,#e0f2fe)",
  },
  da: {
    primary: "#2563EB",
    soft: "#EFF6FF",
    border: "#bfdbfe",
    tagBg: "linear-gradient(135deg,#eff6ff,#dbeafe)",
  },
  en: {
    primary: "#92400E",
    soft: "#FEF3C7",
  ...
  ar: {
    ...
    soft: "#FFFBEB",
    border: "#fde68a",
    tagBg: "linear-gradient(135deg,#fffbeb,#fef3c7)",
  },
};
...
const CONTACT_DATA = {
  da: {
    intro:
      "Har du spørgsmål til et lægemiddel eller en kommentar til siden? Skriv til mig — jeg svarer inden for 1–2 hverdage.",
    chatTitle: "Chat direkte med Ibrahim",
    chatDesc:
      "Du kan også chatte med mig live via chat-ikonet nederst til højre på siden.",
    emailLabel: "Eller skriv på e-mail",
    emailNote: "Svar inden for 1–2 hverdage",
    responseTitle: "Du kan skrive om:",
    topics: [
      "Spørgsmål om et specifikt lægemiddel",
      "Forslag til nye emner",
      "Fejl eller unøjagtigheder på siden",
      "Generel feedback",
    ],
  },
  en: {
    intro:
      "Do you have a question about a medicine or a comment about the site? Write to me — I respond within 1–2 working days.",
    chatTitle: "Chat directly with Ibrahim",
    chatDesc:
      "You can also chat with me live via the chat icon in the bottom right corner of the page.",
    ...
    topics: [
      ...
      "Errors or inaccuracies on the site",
      "General feedback",
    ],
  },
  so: {
    intro:
      "Ma qabtaa su'aal ku saabsan daawo ama faallo ku saabsan bogga? Ii qor — waxaan kuugu jawaabi doonaa 1 ilaa 2 maalmood oo shaqo gudahood.",
    chatTitle: "Si toos ah ula sheekayso Ibraahim",
    chatDesc:
      "Waxaad sidoo kale si toos ah iigula sheekaysan kartaa adigoo isticmaalaya astaanta chat-ka ee ku taalla geeska hoose ee midig ee bogga.",
    emailLabel: "Ama iigu soo dir email",
    emailNote:
      "Jawaab ayaad heli doontaa 1 ilaa 2 maalmood oo shaqo gudahood",
    responseTitle: "Waxaad iigu soo qori kartaa:",
    topics: [
      "Su'aalo ku saabsan daawo gaar ah",
      "Talooyin ku saabsan mawduucyo cusub",
      "Khaladaad ama xog aan sax ahayn oo ku jirta bogga",
      "Faallo guud",
    ],
  },
  ar: {
    intro:
      "هل لديك سؤال حول دواء أو تعليق على الموقع؟ راسلني — سأرد خلال يوم أو يومين عمل.",
    chatTitle: "تحدث مع إبراهيم مباشرةً",
    chatDesc:
      "يمكنك أيضاً التحدث معي مباشرةً عبر أيقونة المحادثة في الزاوية السفلية اليمنى من الصفحة.",
    emailLabel: "أو راسلني عبر البريد الإلكتروني",
    emailNote: "سيتم الرد خلال يوم أو يومين عمل",
    responseTitle: "يمكنك الكتابة عن:",
    topics: [
      "أسئلة حول دواء معين",
      "اقتراحات لموضوعات جديدة",
...
const ABOUT_ME_BULLETS = {
  da: [
    {
      icon: "education",
      text: "Bachelor i Kemi og Medicinalbiologi samt uddannet Farmakonom — med en sjælden evne til at gøre komplekse fag som matematik, fysik, kemi og biologi tilgængelige og engagerende",
    },
    {
      icon: "work",
      text: "Daglig praksis på privatapotek og vagtapotek — mødet med patienter i skranken har tydeligt vist, hvor afgørende klar og tryg lægemiddelinformation er",
    },
    {
      icon: "school",
      text: "Erfaren formidler der har hjulpet gymnasieelever og universitetsstuderende med at mestre komplekse fagområder — med tålmodighed, gå-på-mod og et inspirerende læringsmiljø",
    },
    {
      icon: "pills",
      text: "Brænder for at gøre faglig viden nærværende og brugbar — og bringer en unik kombination af dybdegående viden og engageret formidling til enhver sammenhæng",
    },
  ],
  en: [
    {
      icon: "education",
      text: "Bachelor's degree in Chemistry and Medicinal Biology, trained Pharmaconomist — with a rare ability to make complex subjects such as mathematics, physics, chemistry and biology both accessible and engaging",
    },
    {
      icon: "work",
      text: "Daily practice in community and emergency pharmacy — direct patient contact has made it clear how essential clear and trustworthy medicine information truly is",
    },
    {
      icon: "school",
      text: "Experienced educator who has helped upper secondary and university students master demanding subject areas — with patience, determination and an inspiring learning environment",
    },
    {
      icon: "pills",
      text: "Passionate about making professional knowledge meaningful and practical — bringing a unique combination of in-depth expertise and lively communication to every context",
    },
  ],
  so: [
    {
      icon: "education",
      text: "Shahaadada koowaad ee Kimistariga iyo Bayoolajiga Dawooyinka, waxaana sidoo kale ahay farmashiiste tababaran — leh awood gaar ah oo uu ku fududeeyo maaddooyinka adag sida xisaabta, fiisigiska, kimistariga iyo bayoolajiga, kana dhigo kuwo xiiso leh oo la fahmi karo",
    },
    {
      icon: "work",
      text: "Khibrad maalinle ah oo ka timid farmashiyaha gaarka loo leeyahay iyo farmashiyaha heeganka — la macaamilka bukaannada ayaa si cad u muujiyay sida ay muhiim u tahay in la helo macluumaad daawo oo cad oo lagu kalsoonaan karo",
    },
    {
      icon: "school",
      text: "Waa bare khibrad leh oo ka caawiyay ardayda dugsiga sare iyo jaamacadda inay si fiican u fahmaan maaddooyinka adag — isagoo adeegsanaya dulqaad, dhiirrigelin iyo jawi waxbarasho oo wanaagsan",
    },
    {
      icon: "pills",
      text: "Wuxuu aad u daneeyaa in aqoonta xirfadeed laga dhigo mid nolosha wax ka taraysa oo si fudud loo adeegsan karo — isagoo isku daraya aqoon qoto dheer iyo hab faahfaahin oo firfircoon",
    },
  ],
  ar: [
    {
      icon: "education",
      text: "بكالوريوس في الكيمياء وعلم الأحياء الدوائي، وحاصل على تأهيل فارماكونوم — بقدرة نادرة على تحويل المواد المعقدة كالرياضيات والفيزياء والكيمياء وعلم الأحياء إلى مواد سهلة وممتعة",
    },
    {
      icon: "work",
      text: "ممارسة يومية في الصيدلية الخاصة وصيدلية المناوبة — أوضح التواصل المباشر مع المرضى مدى أهمية المعلومات الدوائية الواضحة والموثوقة",
    },
    {
      icon: "school",
      text: "معلم متمرس ساعد طلاب المرحلة الثانوية والجامعية على إتقان المجالات الدراسية الصعبة — بصبر وعزم وبيئة تعليمية ملهمة",
    },
    {
      icon: "pills",
      text: "شغوف بجعل المعرفة المتخصصة ذات معنى وقابلة للتطبيق — يجمع بين العمق العلمي والتواصل الحيوي في كل سياق",
    },
  ],
};
...
const ABOUT_SITE_BULLETS = {
  ...
  so: [
    { icon: "pills", text: "25 daawo oo si taxaddar leh looga soo xulay shaqada maalinlaha ah ee farmashiyaha" },
    { icon: "school", text: "Waxaa lagu heli karaa af-Deenish, Ingiriisi, Soomaali iyo Carabi" },
    { icon: "education", text: "Waxa qoray farmashiiste si buuxda u tababaran" },
    { icon: "work", text: "Si joogto ah ayaa loogu dari doonaa: antibiyootig, dawooyinka fayraska, dawooyinka xasaasiyadda iyo kuwo kale" },
  ],
  ar: [
...
// ── FAQ — corrected Somali + standard food phrasing ───────────────────────
const FAQ_DATA = {
  da: {
    items: [
      {
        ...
        bullets: [
          "Bruges mod epilepsi og bipolar lidelse",
          "Tages på samme tidspunkt hver dag — med eller uden mad",
          "Glem en dosis? Tag den, så snart du husker — aldrig dobbelt",
          "Stop aldrig pludseligt — tal med din læge først",
        ],
      },
      {
        q: "Kan jeg tage Paracetamol og Ibuprofen på samme tid?",
        bullets: [
          "Ja — de virker forskelligt og kan kombineres",
          "Paracetamol: maks. 2 tabletter ad gangen, maks. 8 i døgnet, mindst 4–6 timer imellem",
          "Ibuprofen: maks. 2 tabletter ad gangen, maks. 6 i døgnet, mindst 6–8 timer imellem",
          "Tag altid Ibuprofen til mad — det skåner maven",
        ],
      },
      {
        q: "Hvad skal jeg undgå under Marevan-behandling?",
        bullets: [
          "Undgå pludselige store ændringer i grønkål, spinat, broccoli og persille (K-vitamin)",
          "Undgå Ibuprofen og Diclofenac — øger blødningsrisikoen",
          "Begræns alkohol",
          "Mød op til dine regelmæssige blodprøver og fortæl altid din læge og tandlæge om behandlingen",
        ],
      },
      {
        q: "Hvornår tages Atorvastatin, og kan jeg spise grapefrugt?",
        bullets: [
          "Kan tages på alle tidspunkter — vigtigst er at tage det på samme tid hver dag",
          "Tages med eller uden mad",
          "Undgå store mængder grapefrugt — det øger risikoen for bivirkninger, særligt muskelsmerter",
        ],
      },
      {
        q: "Hvad er Metformin, og hvornår tages det?",
        bullets: [
          "En velafprøvet diabetesmedicin der holder blodsukkeret nede",
          "Tages altid til mad eller umiddelbart efter — aldrig på tom mave",
          "Mavegener i starten er normalt — kroppen vænner sig typisk inden for 2–4 uger",
        ],
      },
      {
        q: "Hvad er blodtryksmedicin, og hvordan tages Amlodipin, Losartan og Enalapril?",
        bullets: [
          "Holder blodtrykket nede og beskytter hjerte og blodkar over tid",
          "Alle tre tages én gang dagligt — med eller uden mad",
          "Tag dem på samme tidspunkt hver dag, selv hvis du ikke mærker noget",
        ],
      },
      {
        q: "Kan jeg tage Ibuprofen, hvis jeg tager blodtryksmedicin?",
        bullets: [
          "Frarådes i de fleste tilfælde — Ibuprofen kan svække blodtryksmedicinen",
          "Kan også belaste nyrerne ved visse typer blodtryksmedicin",
          "Brug Paracetamol i stedet — det er sikrere",
          "Spørg altid dit apotek eller din læge",
        ],
      },
      {
        q: "Hvad sker der, hvis jeg stopper med Lamotrigin eller Sertralin fra den ene dag til den anden?",
        bullets: [
          "Lamotrigin: kan udløse anfald, selv om du har været anfaldsfri i lang tid",
          "Sertralin: kan give svimmelhed, prikkende fornemmelse, søvnproblemer og humørsvingninger",
          "Begge skal altid nedtrappes langsomt under lægelig vejledning",
        ],
      },
      {
        q: "Hvad gør jeg, hvis jeg har taget for mange Paracetamol?",
        bullets: [
          "Ring straks til Giftlinjen: 82 12 12 12 — åben hele døgnet, gratis",
          "Ring 112 i akutte tilfælde",
          "Leversskaden kan opstå over 24–72 timer — vent ikke på symptomer",
          "Tag emballagen med, så personalet kan se hvad du har taget",
        ],
      },
      {
        q: "Kan Atorvastatin give muskelsmerter?",
        bullets: [
          "Ja — spredt ømhed eller svaghed i muskler er en velkendt bivirkning",
          "Kontakt din læge ved vedvarende muskelsmerter, muskelsvaghed eller mørk urin",
          "Din læge kan justere din dosis eller skifte til en anden type",
        ],
      },
      {
        q: "Hvilket smertestillende virker bedst?",
        bullets: [
          "Paracetamol: bedst til hovedpine, feber og lettere smerter — sikkert for de fleste",
          "Ibuprofen: stærkere, god ved tandpine, muskelsmerter og ledsmerter — tag til mad",
          "Har du mavegener, tager blodtryksmedicin eller er gravid? Brug Paracetamol",
          "Er du i tvivl? Spørg dit apotek",
        ],
      },
      {
        q: "Kan jeg tage et nyt håndkøbsmiddel sammen med min faste medicin?",
        bullets: [
          "Ikke nødvendigvis — mange håndkøbsmediciner påvirker din faste medicin",
          "Ibuprofen kan fx svække blodtryksmedicin",
          "Naturlægemidler kan påvirke blodfortyndende medicin",
          "Spørg altid på apoteket — det er gratis og tager 2 minutter",
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        bullets: [
          ...
          "Missed a dose? Take it when you remember — never double up",
          "Never stop suddenly — always speak to your doctor first",
        ],
      },
      {
        q: "Can I take Paracetamol and Ibuprofen at the same time?",
        bullets: [
          "Yes — they work differently and can be combined",
          "Paracetamol: max. 2 tablets per dose, max. 8 per day, at least 4–6 hours apart",
          "Ibuprofen: max. 2 tablets per dose, max. 6 per day, at least 6–8 hours apart",
          "Always take Ibuprofen with food to protect the stomach",
        ],
      },
      {
        q: "What should I avoid while taking Warfarin (Marevan)?",
        bullets: [
          "Avoid sudden large changes in kale, spinach, broccoli and parsley (vitamin K)",
          "Avoid Ibuprofen and Diclofenac — increases bleeding risk",
          "Limit alcohol",
          "Attend regular blood tests and always tell your doctor and dentist about your treatment",
        ],
      },
      {
        q: "When should I take Atorvastatin, and can I eat grapefruit?",
        bullets: [
          "Can be taken at any time — most important is to take it at the same time each day",
          "Can be taken with or without food",
          "Avoid large amounts of grapefruit — it increases the risk of side effects, particularly muscle pain",
        ],
      },
      {
        q: "What is Metformin, and when should it be taken?",
        bullets: [
          "A well-tested diabetes medicine that keeps blood sugar down",
          "Always take with or immediately after a meal — never on an empty stomach",
          "Stomach problems at the start are normal — the body usually adjusts within 2–4 weeks",
        ],
      },
      {
        q: "What is blood pressure medicine, and how is Amlodipine, Losartan and Enalapril taken?",
        bullets: [
          "Keeps blood pressure down and protects the heart and blood vessels over time",
          "All three taken once daily — with or without food",
          "Take at the same time every day, even if you feel nothing",
        ],
      },
      {
        q: "Can I take Ibuprofen while on blood pressure medicine?",
        bullets: [
          "Not recommended in most cases — Ibuprofen can weaken blood pressure medicine",
          "Can also strain the kidneys with certain blood pressure medicines",
          "Use Paracetamol instead — it is safer",
      ...
      },
      {
        ...
        bullets: [
          "Lamotrigine: can trigger seizures, even after a long seizure-free period",
          "Sertraline: can cause dizziness, tingling, sleep problems and mood swings",
          "Both must always be tapered down slowly under medical guidance",
        ],
      },
      {
        q: "What do I do if I have taken too many Paracetamol tablets?",
        bullets: [
          "Call Giftlinjen immediately: 82 12 12 12 — open around the clock, free of charge",
          "Call 112 in emergencies",
          "Liver damage can develop over 24–72 hours — do not wait for symptoms",
          "Bring the packaging so staff know exactly what was taken",
        ],
      },
      {
        q: "Can Atorvastatin cause muscle pain?",
        bullets: [
          "Yes — widespread aching or weakness in muscles is a well-known side effect",
          "Contact your doctor for persistent muscle pain, weakness or dark urine",
          "Your doctor can adjust your dose or switch to a different type",
        ],
      },
      {
        q: "Which pain reliever works best?",
        bullets: [
          "Paracetamol: best for headache, fever and mild pain — safe for most people",
          "Ibuprofen: stronger, good for toothache, muscle and joint pain — take with food",
          "Stomach problems, blood pressure medicine or pregnant? Use Paracetamol",
      ...
      },
      {
        ...
        bullets: [
          "Not always — many over-the-counter medicines affect your regular medicine",
          "Ibuprofen can weaken blood pressure medicine",
          "Herbal remedies can affect blood-thinning medicine",
          "Always ask at the pharmacy — it is free and takes 2 minutes",
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        bullets: [
          "Waxaa loo isticmaalaa suuxdinta iyo cudurka laba-cirifoodka",
          "Qaado wakhti isku mid ah maalin kasta",
          "Daawadan waxaa la qaadan karaa adigoon cunto cunin ama adigoo cunto la qaadanaya.",
          "Haddii aad hilmaanto qiyaas, qaado marka aad xasuusato — hana labanlaabin qiyaasta",
          "Ha joojin daawada si kedis ah — marka hore la hadal dhakhtarkaaga",
        ],
      },
      {
        q: "Ma wada qaadan karaa Paracetamol iyo Ibuprofen isku mar?",
        bullets: [
          "Haa — labadan daawo si kala duwan ayay u shaqeeyaan, waxaana mararka qaarkood la isku dari karaa",
          "Paracetamol: ugu badnaan 2 kiniin hal mar, ugu badnaan 8 kiniin 24 saacadood gudahood, ugu yaraan 4–6 saacadood ha u dhexeeyaan",
          "Ibuprofen: ugu badnaan 2 kiniin hal mar, ugu badnaan 6 kiniin 24 saacadood gudahood, ugu yaraan 6–8 saacadood ha u dhexeeyaan",
          "Ibuprofen mar walba ku qaado cunto si caloosha loo ilaaliyo",
        ],
      },
      {
        q: "Maxaan iska ilaalinayaa marka aan qaadanayo Marevan?",
        bullets: [
          "Ka fogow isbeddel degdeg ah oo ku yimaada cunista kaabashka cagaaran, isbinaajka, brokoliga iyo dhir-caleedka (fitamiin K)",
          "Ka fogow Ibuprofen iyo Diclofenac — waxay kordhin karaan khatarta dhiig-baxa",
          "Yaree cabbitaanka khamriga",
          "Si joogto ah u samee baaritaannada dhiigga, mar walbana u sheeg dhakhtarkaaga iyo dhakhtarka ilkaha inaad qaadanayso Marevan",
        ],
      },
      {
        q: "Goorma ayaa la qaataa Atorvastatin, ma cuni karaa canab-guduudan?",
        bullets: [
          "Waxaa la qaadan karaa wakhti kasta — waxa ugu muhiimsan waa in maalin kasta la qaato wakhti isku mid ah",
          "Daawadan waxaa la qaadan karaa adigoon cunto cunin ama adigoo cunto la qaadanaya.",
          "Ka fogow xaddi badan oo canab-guduudan ah — waxay kordhin kartaa khatarta waxyeellada daawada, gaar ahaan murqo-xanuunka",
        ],
      },
      {
        q: "Waa maxay Metformin, goormase la qaataa?",
        bullets: [
          "Waa daawo sonkorow oo si fiican loo tijaabiyay, kana caawisa hoos u dhigista sonkorta dhiigga",
          "Mar walba ku qaado cunto ama isla markiiba cuntada ka dib — ha ku qaadan calool madhan",
          "Dhibaatooyinka caloosha ee bilowga ah waa wax caadi ah — badanaa jirku wuu la qabsadaa 2 ilaa 4 toddobaad gudahood",
        ],
      },
      {
        q: "Waa maxay daawooyinka dhiig-karka, sideese loo qaataa Amlodipin, Losartan iyo Enalapril?",
        bullets: [
          "Waxay hoos u dhigaan dhiig-karka, waxayna muddo dheer ilaaliyaan wadnaha iyo xididdada dhiigga",
          "Saddexdaba hal mar ayaa la qaataa maalin kasta",
          "Daawadan waxaa la qaadan karaa adigoon cunto cunin ama adigoo cunto la qaadanaya.",
          "Ku qaado wakhti isku mid ah maalin kasta, xitaa haddii aadan wax calaamado ah dareemayn",
        ],
      },
      {
        q: "Ma qaadan karaa Ibuprofen haddii aan qaadanayo daawada dhiig-karka?",
        bullets: [
          "Inta badan laguma taliyo — Ibuprofen waxay daciifin kartaa saameynta daawada dhiig-karka",
          "Waxay sidoo kale culays saari kartaa kelyaha, gaar ahaan daawooyin dhiig-kar oo qaarkood",
          "Paracetamol ayaa badanaa ka ammaan badan",
          "Mar walba la tasho farmashiistahaaga ama dhakhtarkaaga",
        ],
      },
      {
        q: "Maxaa dhici kara haddii aan si kedis ah u joojiyo Lamotrigin ama Sertralin?",
        bullets: [
          "Lamotrigin: waxay keeni kartaa in suuxdintu dib u soo noqoto, xitaa haddii aad muddo dheer fiicnayd",
          "Sertralin: waxay keeni kartaa dawakh, dareen gubasho ama mudid ah, hurdo-xumo iyo isbeddel niyadeed",
          "Labadan daawo waa in si tartiib tartiib ah loo yareeyaa, iyadoo uu dhakhtar hagayo",
        ],
      },
      {
        q: "Maxaan sameeyaa haddii aan qaatay Paracetamol ka badan intii la rabay?",
        bullets: [
          "Isla markiiba wac Giftlinjen: 82 12 12 12 — waxay furan tahay 24 saacadood, waana bilaash",
          "Wac 112 haddii ay xaaladdu degdeg tahay",
          "Dhaawaca beerka wuxuu soo bixi karaa 24 ilaa 72 saacadood gudahood — ha sugin calaamadaha",
          "Qaado baakadka daawada si shaqaalaha caafimaadku u arkaan waxa aad qaadatay",
        ],
      },
      {
        q: "Atorvastatin ma keeni kartaa murqo-xanuun?",
        bullets: [
          "Haa — murqo-xanuun ama murqo-daciifnimo waa waxyeello la yaqaan",
          "La xiriir dhakhtarkaaga haddii murqo-xanuunku sii socdo, aad dareento murqo-daciifnimo ama kaadidu noqoto madow",
          "Dhakhtarkaagu wuxuu beddeli karaa qiyaasta ama nooca daawada",
        ],
      },
      {
        q: "Daawada xanuun-baabi'iyaha ah kee fiican?",
        bullets: [
          "Paracetamol: waxay ku fiican tahay madax-xanuun, qandho iyo xanuun fudud — dad badan ayay ammaan u tahay",
          "Ibuprofen: way ka xoog badan tahay, waxayna ku fiican tahay ilko-xanuun, murqo-xanuun iyo kala-goysyo xanuunaya — ku qaado cunto",
          "Haddii aad leedahay calool-xanuun, aad qaadato daawo dhiig-kar ama aad uur leedahay, Paracetamol ayaa badanaa ka habboon",
          "Haddii aad shaki qabto, weydii farmashiistahaaga",
        ],
      },
      {
        q: "Ma qaadan karaa daawo cusub oo farmashiyaha laga helo anigoo qaadanaya daawooyinkayga caadiga ah?",
        bullets: [
          "Mar walba ma aha — daawooyin badan oo aan warqad dhakhtar u baahnayn waxay saameyn karaan daawooyinkaaga kale",
          "Ibuprofen waxay daciifin kartaa daawooyinka dhiig-karka",
          "Daawooyinka dabiiciga ah qaarkood waxay saameyn karaan dawooyinka dhiig-khafiifiya",
          "Mar walba weydii farmashiistaha — waa bilaash, waana degdeg",
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        bullets: [
          "يُستخدم للصرع والاضطراب ثنائي القطب",
          "تناوله في نفس الوقت يومياً — مع الطعام أو بدونه",
          "نسيت جرعة؟ تناولها حين تتذكر — لا تُضاعف الجرعة",
          "لا توقفه فجأة — تحدث مع طبيبك أولاً",
        ],
      },
      {
        q: "هل يمكن تناول الباراسيتامول والإيبوبروفين معاً؟",
        bullets: [
          "نعم — يعملان بطريقتين مختلفتين ويمكن الجمع بينهما",
          "باراسيتامول: أقصى قرصان في المرة، 8 يومياً، 4–6 ساعات على الأقل بين الجرعات",
          "إيبوبروفين: أقصى قرصان في المرة، 6 يومياً، 6–8 ساعات على الأقل بين الجرعات",
          "تناول الإيبوبروفين دائماً مع الطعام لحماية المعدة",
        ],
      },
      {
        q: "ما الذي يجب تجنبه أثناء علاج الوارفارين؟",
        bullets: [
          "تجنّب التغيرات المفاجئة في اللفت والسبانخ والبروكلي والبقدونس (فيتامين K)",
          "تجنّب الإيبوبروفين والديكلوفيناك — يزيدان خطر النزيف",
          "اعتدل في الكحول",
          "احضر فحوصات الدم بانتظام وأخبر طبيبك وطبيب الأسنان دائماً",
        ],
      },
      {
        q: "متى يُؤخذ أتورفاستاتين وهل يمكن تناول الجريب فروت؟",
        bullets: [
          "يمكن تناوله في أي وقت — الأهم الالتزام بنفس الوقت يومياً",
          "مع الطعام أو بدونه — كلاهما صحيح",
          "تجنّب كميات كبيرة من الجريب فروت — يزيد خطر الآثار الجانبية لا سيما آلام العضلات",
        ],
      },
      {
        q: "ما هو ميتفورمين ومتى يُؤخذ؟",
        bullets: [
          "دواء سكري موثوق يساعد على خفض مستوى السكر في الدم",
          "تناوله دائماً مع الوجبة أو بعدها مباشرة — ليس على معدة فارغة",
          "مشاكل المعدة في البداية طبيعية — الجسم يعتاد عادةً خلال 2–4 أسابيع",
        ],
      },
      {
        q: "ما هي أدوية ضغط الدم وكيف يُؤخذ أملوديبين ولوسارتان وإيناليبريل؟",
        bullets: [
          "تُخفض ضغط الدم وتحمي القلب والأوعية الدموية مع مرور الوقت",
          "تُؤخذ الثلاثة مرة واحدة يومياً — مع الطعام أو بدونه",
          "تناولها في نفس الوقت كل يوم، حتى لو لم تشعر بشيء",
        ],
      },
      {
        q: "هل يمكن تناول الإيبوبروفين مع أدوية ضغط الدم؟",
        bullets: [
          "لا يُنصح به في أغلب الحالات — قد يُضعف أدوية ضغط الدم",
          "قد يُجهد الكلى مع بعض أنواع هذه الأدوية",
          "استخدم الباراسيتامول بدلاً منه — أكثر أماناً",
          "استشر الصيدلي أو طبيبك دائماً",
        ],
      },
      {
        q: "ماذا يحدث إذا توقفت فجأة عن لاموتريجين أو سيرترالين؟",
        bullets: [
          "لاموتريجين: قد يُسبب نوبات صرع حتى بعد فترة طويلة بلا نوبات",
          "سيرترالين: قد يُسبب دواراً ووخزاً ومشاكل نوم وتقلبات مزاجية",
          "يجب تخفيض كلاهما تدريجياً تحت إشراف الطبيب",
        ],
      },
      {
        q: "ماذا أفعل إذا تناولت جرعة زائدة من الباراسيتامول؟",
        bullets: [
          "اتصل فوراً بـ Giftlinjen: 82 12 12 12 — مفتوح 24 ساعة، مجاناً",
          "اتصل بـ 112 في حالات الطوارئ",
          "تلف الكبد قد يحدث خلال 24–72 ساعة — لا تنتظر الأعراض",
          "أحضر عبوة الدواء ليعرف الكوادر الطبية ما تناولته",
        ],
      },
      {
        q: "هل يمكن لأتورفاستاتين أن يسبب آلام عضلية؟",
        bullets: [
          "نعم — ألم منتشر أو ضعف في العضلات من الآثار الجانبية المعروفة",
          "تواصل مع طبيبك عند آلام مستمرة أو ضعف عضلي أو بول داكن",
          "يمكن تعديل الجرعة أو تغيير الدواء",
        ],
      },
      {
        q: "أي مسكن ألم هو الأفضل؟",
        bullets: [
          "باراسيتامول: للصداع والحمى والآلام الخفيفة — آمن للغالبية",
          "إيبوبروفين: أقوى، للأسنان والعضلات والمفاصل — مع الطعام دائماً",
          "مشاكل معدة أو ضغط دم أو حمل؟ استخدم الباراسيتامول",
          "في حال الشك، اسأل الصيدلي",
        ],
      },
      {
        q: "هل يمكن تناول دواء جديد بدون وصفة مع دوائي المعتاد؟",
        bullets: [
          "ليس دائماً — كثير من هذه الأدوية تؤثر على دوائك المعتاد",
          "الإيبوبروفين قد يُضعف أدوية ضغط الدم",
          "بعض الأعشاب الطبية قد تؤثر على مرقِّقات الدم",
          "استشر الصيدلية دائماً — مجاني ولا يستغرق أكثر من دقيقتين",
        ],
      },
    ],
  },
...
const FEEDBACK_DATA = {
  da: {
    subtitle: "Din mening betyder noget. Del gerne din oplevelse med Somalimed.",
    praise: "Ros 👍",
    criticism: "Ris 👎",
    suggestion: "Forslag 💡",
    placeholder: "Skriv din besked her...",
    send: "Send besked",
    sent: "Tak for din besked! 🙏",
    emailLabel: "Din e-mail (valgfri)",
  },
  en: {
    subtitle: "Your opinion matters. Feel free to share your experience with Somalimed.",
    praise: "Praise 👍",
    criticism: "Criticism 👎",
  ...
  so: {
    subtitle: "Ra'yaagaagu waa muhiim. Nala wadaag khibradaada Somalimed.",
    praise: "Amaano 👍",
    criticism: "Dhaleeceyn 👎",
    suggestion: "Talooyin 💡",
    placeholder: "Halkan ku qor fariintaada...",
    send: "Dir fariinta",
    sent: "Mahadsanid fariintaada! 🙏",
    emailLabel: "Emailkaaga (ikhtiyaari)",
  },
  ar: {
    subtitle: "رأيك يهمنا. شاركنا تجربتك مع Somalimed.",
    praise: "إطراء 👍",
    criticism: "نقد 👎",
    suggestion: "اقتراح 💡",
    placeholder: "اكتب رسالتك هنا...",
    send: "إرسال الرسالة",
    sent: "شكراً على رسالتك! 🙏",
...
function getPillMeta(l) {
  return CATEGORY_PILL_ICON[l] || { icon: "download.png", color: "#0D9488", bg: "#F0FDFA" };
}
...
function QuestionIcon({ size = 16, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
...
function AboutModal({ tab, language, onClose }) {
  ...
  const bullets =
    tab === "me"
      ? ABOUT_ME_BULLETS[language] ?? ABOUT_ME_BULLETS.so
      : ABOUT_SITE_BULLETS[language] ?? ABOUT_SITE_BULLETS.so;
    ...
    <ModalShell title={title} iconEl={iconEl} onClose={onClose} isRtl={isRtl}>
      {tab === "me" && (
        ...
        >
          ...
          <div>
            <p style={{ fontWeight: 800, fontSize: "19px", color: "#0f172a", margin: 0 }}>
              {meMeta.name}
            </p>
            <p
              style={{
  ...
  return (
    <ModalShell title={navLabels.contact} iconEl={iconEl} onClose={onClose} isRtl={isRtl}>
      ...
      >
        ...
        <div>
          <p style={{ fontWeight: 700, fontSize: "15px", color: theme.primary, margin: 0 }}>
            {data.chatTitle}
          </p>
          <p style={{ fontSize: "13px", color: "#64748b", margin: "3px 0 0", lineHeight: 1.5 }}>
            {data.chatDesc}
          </p>
        </div>
      </div>
      ...
      <a
        href="mailto:Ibrahim_skb@live.dk"
        style={{
          display: "flex",
          alignItems: "center",
          gap: "12px",
    ...
    <ModalShell title={navLabels.feedback} iconEl={iconEl} onClose={onClose} isRtl={isRtl}>
      {sent ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          <p style={{ fontSize: "14px", color: "#64748b", margin: 0, textAlign: isRtl ? "right" : "left" }}>
            {data.subtitle}
          </p>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  transition: "all 0.2s",
                  borderColor: type === key ? theme.primary : "#e2e8f0",
                  background: type === key ? theme.primary : "#fff",
...
function FloatingChatHint({ language, onOpen }) {
  const isRtl = language === "ar";
  const theme = LANG_THEME[language] ?? LANG_THEME.so;
  const label = CHAT_PLUGIN_HINT[language] ?? CHAT_PLUGIN_HINT.so;
...
export function SiteIndex({ initialLang }) {
  ...
  const navTabs = useMemo(
    () => [
      {
        key: "me",
        iconEl: <img src={P.education} alt="" style={{ width: 15, height: 15, objectFit: "contain" }} />,
        label: navLabels.aboutMe,
      },
      {
        key: "site",
        iconEl: <img src={P.work} alt="" style={{ width: 15, height: 15, objectFit: "contain" }} />,
        label: navLabels.aboutSite,
      },
      {
        key: "faq",
        iconEl: <QuestionIcon size={15} color={iconColors.faq} />,
        label: navLabels.faq,
      },
      {
        key: "feedback",
        iconEl: <StarIcon size={15} color={iconColors.feedback} />,
        label: navLabels.feedback,
      },
      {
        key: "contact",
        iconEl: <MailIcon size={15} color={iconColors.contact} />,
  ...
  return (
    <div style={{ background: "var(--bg)", color: "var(--text)" }} className="min-h-screen">
            ...
            {navTabs.map(({ key, iconEl, label }) => {
              ...
              return (
                <button
                  key={key}
                  type="button"
                  onClick={() => setModalTab(active ? null : key)}
                  style={{
                    display: "inline-flex",
                    alignItems: "center",
                    gap: "5px",
      ...
      {/* ── Modals ─────────────────────────────────────────────────────── */}
      {(modalTab === "me" || modalTab === "site") && (
        <AboutModal tab={modalTab} language={language} onClose={() => setModalTab(null)} />
      )}
      {modalTab === "faq" && <FAQModal language={language} onClose={() => setModalTab(null)} />}
      {modalTab === "feedback" && (
        <FeedbackModal language={language} onClose={() => setModalTab(null)} />
      )}
      {modalTab === "contact" && (
        <ContactModal language={language} onClose={() => setModalTab(null)} />
      )}
      ...
      {/* ── Floating chat hint ───────────────────────────────────────────── */}
      <FloatingChatHint language={language} onOpen={() => setModalTab("contact")} />
    </div>
  );
}
