...
const CONTACT_DATA = {
  ...
  so: {
    intro: "Ma qabtaa su'aal ku saabsan daawo ama faallo ku saabsan bogga? Ii qor — waxaan kuugu jawaabi doonaa 1–2 maalmood gudahood.",
    chatTitle: "La xiriir Ibraahim si toos ah",
    chatDesc: "Waxaad sidoo kale iigu soo gudbin kartaa su'aalahaaga adigoo adeegsanaya astaanta sheekaysiga ee ku taalla geeska hoose ee midig ee bogga.",
    emailLabel: "Ama iigu qor email",
    emailNote: "Jawaab ayaad heli doontaa 1–2 maalmood gudahood",
    responseTitle: "Waxaad wax iiga qori kartaa:",
    topics: ["Su'aalo ku saabsan daawo gaar ah", "Talooyin ku saabsan mawduucyo cusub", "Khaladaad ama xog aan sax ahayn", "Faallo guud"],
  },
  ar: {
...
const ABOUT_ME_BULLETS = {
  ...
  so: [
    { icon: "education", text: "Shahaadada koowaad ee Kimistariga iyo Bayoolajiga Dawooyinka, waxaana sidoo kale ahay farmashiiste tababaran — leh awood gaar ah oo uu ku fududeeyo maaddooyinka adag sida xisaabta, fiisigiska, kimistariga iyo bayoolajiga, kana dhigo kuwo sahlan oo xiiso leh" },
    { icon: "work", text: "Khibrad maalinle ah oo ka timid farmashiyaha bulshada iyo farmashiyaha xaaladaha degdegga ah — xiriirka tooska ah ee bukaannada ayaa si cad u muujiyay baahida weyn ee loo qabo macluumaad daawo oo cad oo lagu kalsoonaan karo" },
    { icon: "school", text: "Macallin khibrad leh oo ka caawiyay ardayda dugsiga sare iyo jaamacadda inay si fiican ugu guulaystaan maaddooyinka adag — isagoo adeegsanaya dulqaad, dhiirrigelin iyo jawi waxbarasho oo waxtar leh" },
    { icon: "pills", text: "Wuxuu si gaar ah u daneeyaa in aqoonta xirfadeed laga dhigo mid macno leh oo la adeegsan karo — isagoo keenaya isku darka aqoon qoto dheer iyo hab sharaxaad oo firfircoon" },
  ],
  ar: [
...
const ABOUT_SITE_BULLETS = {
  ...
  so: [
    ...
    { icon: "work", text: "Waxaa si joogto ah loogu dari doonaa: antibiyootigyo, daawooyinka fayraska, daawooyinka xasaasiyadda iyo kuwo kale" },
  ],
  ar: [
  ...
  so: { items: [
    { q: "Waa maxay Lamotrigin, sideese loo qaataa?",
      bullets: [
        ...
        "Qaado wakhti isku mid ah maalin kasta. Daawadan waxaa la qaadan karaa adigoon cunto cunin ama adigoo cunto la qaadanaya.",
        "Haddii aad hilmaanto qiyaasta, qaado marka aad xasuusato — hana labanlaabin qiyaasta.",
    ...
    { q: "Maxaan iska ilaalinayaa marka aan qaadanayo Marevan?",
      bullets: [
        "Ka fogow isbeddel weyn oo kedis ah oo ku yimaada cunista kaabashka cagaaran, isbinaajka, brokoliga iyo dhir-caleedka (fitamiin K).",
    ...
    { q: "Ma qaadan karaa Ibuprofen haddii aan qaadanayo daawada dhiig-karka?",
      bullets: [
        ...
        "Waxay sidoo kale culays saari kartaa kelyaha, gaar ahaan noocyo ka mid ah daawooyinka dhiig-karka.",
    ...
    { q: "Maxaa dhici kara haddii aan si kedis ah u joojiyo Lamotrigin ama Sertralin?",
      bullets: [
        ...
        "Sertralin: waxay keeni kartaa dawakh, dareen mudid ama gubasho ah, hurdo-xumo iyo isbeddel niyadeed.",
    ...
    { q: "Daawada xanuun-baabi'iyaha ah kee fiican?",
      bullets: [
        ...
        "Haddii aad leedahay dhibaato caloosha ah, aad qaadato daawo dhiig-kar ama aad uur leedahay, Paracetamol ayaa badanaa ka habboon.",
...
const FEEDBACK_DATA = {
  ...
  so: { subtitle: "Ra'yaagaagu waa muhiim. Nala wadaag khibradaada Somalimed.", praise: "Ammaan 👍", criticism: "Dhaliil 👎", suggestion: "Talo 💡", placeholder: "Halkan ku qor fariintaada...", send: "Dir fariinta", sent: "Mahadsanid fariintaada! 🙏", emailLabel: "Emailkaaga (ikhtiyaari)" },
