...
const CONTACT_DATA = {
  ...
  so: {
    ...
    chatDesc: "Waxaad sidoo kale ii sheegi kartaa su'aalahaaga adoo isticmaalaya badhanka sheekada ee ku yaal geeska midig ee hoose ee bogga.",
...
const FAQ_DATA = {
  ...
  so: { items:[
    { q:"Maxay tahay Lamotrigin, sidaana loo qaadaa?",
      bullets:["Waxaa loo isticmaalaa epilepsy (guba) iyo laba-cirifood","Qaado wakht isku mid ah maalin kasta — cuntada la socota ama la'aanteeda","Haddaad hilmaantid dosista, qaado markii aad xasuusan — ha labanlaabinin","Ha joojiyo si lama filaan ah — la hadal dhakhtarkaaga horta"] },
    { q:"Ma qaadan karaa Paracetamol iyo Ibuprofen isla mar?",
      bullets:["Haa — waxay si kala duwan u shaqeeyaan, waxaana la isku dari karaa","Paracetamol: ugu badan 2 kiniin hal mar, 8 maalintii, ugu yaraan 4–6 saacadood u dhexeeya","Ibuprofen: ugu badan 2 kiniin hal mar, 6 maalintii, ugu yaraan 6–8 saacadood u dhexeeya","Mar walba qaado Ibuprofen cuntada la socota — si looga ilaaliyo caloosha"] },
    { q:"Maxaan ka fogaan karaa intaan qaadanayo Marevan?",
      bullets:["Iska ilaali isbedelada lama filaan ah ee canabka cagaaran, isbinaashka, barootiinka iyo baarsaleeyo","Iska ilaali Ibuprofen iyo Diclofenac — waxay kordhinayaan khatarta dhiig-baxa","Xaddid khamriga","U tag baaritaanada dhiigga si joogto ah; u sheeg dhakhtarkaaga iyo dacawooyaha ilkaha"] },
    { q:"Goorma la qaadaa Atorvastatin, miyaana cirishta lagu cuni karin?",
      bullets:["Waxaa lagu qaadan karaa wakht kasta — waxa muhiimsan waa in wakht isku mid ah lagu qaado","Cuntada la socota ama la'aanteeda — labadaba waa sax","Iska ilaali tirada badan ee cirishta — waxay kordhinaysaa khatarta xanuunka muruqyada"] },
    { q:"Maxay tahay Metformin, goormaana la qaadaa?",
      bullets:["Daawada sonkoraha (diabetes) oo caawin jirka inuu hoos u dhigo heerka sonkoraha","Mar walba qaado cuntada la socota ama isla markiiba ka dib — ha qaadin calool madhan","Dhibaatada caloosha bilowga waa caadi ah — jiruhu wuu qabsadaa 2–4 todobaad gudahood"] },
    { q:"Maxay tahay daawooyinka dhiig-karka, sidaana Amlodipin, Losartan iyo Enalapril loo qaadaa?",
      bullets:["Waxay hoos u dhigeeyaan dhiig-karka oo ilaaliyaan wadnaha iyo xididdada dhiigga","Saddadkooduba waxaa lagu qaadaa hal mar maalintii — cuntada la socota ama la'aanteeda","Qaado wakht isku mid ah maalin kasta, xitaa haddaanad waxba dareensanayn"] },
    { q:"Ma qaadan karaa Ibuprofen haddaan qaadanayo daawooyinka dhiig-karka?",
      bullets:["Inta badan laguma talinayo — Ibuprofen waxay daciifin kartaa daawooyinka dhiig-karka","Waxay sidoo kale culays saari kartaa kelyahaaga","Isticmaal Paracetamol beddelkeeda — waa ammaan","Mar walba weydii farmashiistaha ama dhakhtarkaaga"] },
    { q:"Maxaa dhacaya haddaan si lama filaan ah u joojiyaa Lamotrigin ama Sertralin?",
      bullets:["Lamotrigin: waxay kicin kartaa qodob-xanuunno, xitaa haddaad muddo dheer ahayd xanuun la'aan","Sertralin: waxay keeni kartaa sharar, dareenkii gubasho ah, dhibaatada hurdada iyo isbeddelada xaalada","Labada daawo waa in si tartiib ah hoos loogu dhigo hagitaanka dhakhtarka"] },
    { q:"Maxaan sameeyaa haddaan qaatay Paracetamol badan oo dhaafay?",
      bullets:["Si deg-deg ah u wac Giftlinjen: 82 12 12 12 — furan 24 saacadood, bilaash ah","Wac 112 xaaladaha degdega ah","Dhaawaca beerta waxay dhici kartaa 24–72 saacadood — ha sugin calaamadaha","Qaado xirmada daawooyinka si shaqaalaha ay u ogaadaan waxa aad qaadatay"] },
    { q:"Ma Atorvastatin keeni kartaa xanuunka muruqyada?",
      bullets:["Haa — xanuun kala firirsan ama daciifnimo muruqyada waa saameyn xun caadi ah","La xiriir dhakhtarkaaga haddaad dareento xanuun muruq oo joogto ah, daciifnimo ama kaadi madow","Dhakhtarkaagu wuxuu qiimeyn doonaa haddii la beddelan doono qadarka ama nooca daawada"] },
    { q:"Kuma daawadu xanuunta ugu fiican?",
      bullets:["Paracetamol: ku habboon madax xanuun, qandho iyo xanuun fudud — ammaan u ah dadka inta badan","Ibuprofen: xooggan, ku fiican xanuunka ilkaha, muruqyada iyo xubnoha — qaado cuntada la socota","Dhibaato caloosha, daawooyinka dhiig-karka ama uur? Isticmaal Paracetamol","Shaki qabto? Weydii farmashiistaha"] },
    { q:"Ma qaadan karaa daawooyin cusub oo aan qoraal u baahnayn marka aan qaadanayo daawooyinkayga caadiga ah?",
      bullets:["Maaha had iyo jeer — daawooyin badan oo bilaash ah waxay saameyn karaan daawooyinkaaga","Ibuprofen waxay daciifin kartaa daawooyinka dhiig-karka","Daawooyinka dabiiciga ah qaarkood waxay saameyn karaan daawooyinka dareere-dhiigga","Mar walba weydii farmashiistaha — bilaash waa, waxayna kaa qaadanaysaa 2 daqiiqo"] },
  ]},
  ar: { items:[
              ...
              <div style={{padding:"4px 18px 16px",borderTop:`1px solid ${theme.primary}20`}}>
                <ul style={{listStyle:"none",padding:0,margin:0,display:"flex",flexDirection:"column",gap:"6px"}}>
                  {item.bullets.map((b,bi)=>(
                    <li key={bi} style={{display:"flex",alignItems:"flex-start",gap:"10px",padding:"8px 12px",borderRadius:"10px",background:`${theme.primary}08`,fontSize:"14px",color:"#334155",lineHeight:1.6}}>
                      <span style={{width:6,height:6,borderRadius:"50%",background:theme.primary,flexShrink:0,marginTop:"6px"}}/>
                      {b}
                    </li>
                  ))}
                </ul>
