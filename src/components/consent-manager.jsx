...
const TEXTS = {
  da: {
    title: "Jeg bruger cookies",
    body: "Jeg bruger Google Analytics til at forstå, hvordan siden bruges, og Crisp Chat til at besvare dine spørgsmål. Dine data deles ikke med tredjeparter til kommercielle formål.",
  ...
  en: {
    title: "I use cookies",
    body: "I use Google Analytics to understand how the site is used, and Crisp Chat to answer your questions. Your data is not shared with third parties for commercial purposes.",
    accept: "Accept all",
  ...
  so: {
    title: "Waxaan isticmaalaa cookies",
    body: "Waxaan isticmaalaa Google Analytics si aan u fahmo sida bogga loo adeegsado, iyo Crisp Chat si aan su'aalahaaga uga jawaabo. Xogta kuma wadaago xisbiyada saddexaad ujeedooyin ganacsiga ah.",
  ...
  ar: {
    title: "أستخدم ملفات تعريف الارتباط",
    body: "أستخدم Google Analytics لفهم كيفية استخدام الموقع، وCrisp Chat للرد على أسئلتك. لا تُشارك بياناتك مع أطراف ثالثة لأغراض تجارية.",
    accept: "قبول الكل",
    reject: "الضرورية فقط",
