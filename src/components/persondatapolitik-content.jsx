...
const CONTENT = {
  ...
  so: {
    ...
    rows: [
      ["Foomka xiriirka", "Magaca, magaalada, email-ka iyo lambarka telefoonka (haddii aad bixiso)", "Si aan uga jawaabno fariintaada, ammaanta, dhaleeceynta ama soo jeedintaada.", "Fariinta waxaa si toos ah looga diraa email-kaaga kuna socotaa Ibrahim_skb@live.dk. Laguma kaydiyo keydka xogta (database-ka) ee bogga."],
      ["Google Analytics (GA4)", "Tirakoobka booqashooyinka oo aan lagu aqoonsan karin qofka (IP-ga waa la qariyaa)", "Si aan u fahanno sida bogga loo isticmaalo loona sii horumariyo.", "Ilaa 2 sano — faahfaahinta ka eeg Siyaasadda Cookies-ka."],
      ["Crisp Chat", "Fariimaha chat-ka (haddii aad nala soo xiriirto)", "Si aan uga jawaabno su'aalahaaga iyada oo loo marayo chat-ka tooska ah.", "Ilaa 1 sano — faahfaahinta ka eeg Siyaasadda Cookies-ka."],
    ],
    sections: [
      ...
      { title: "Xogtee ayaan ururinnaa, maxaase loo ururiyaa?", table: true },
      { title: "Aasaaska sharciyeed", body: "Foomka xiriirka waxaa lagu habeeyaa oggolaanshahaaga, maadaama aad adigu dooranayso inaad noo soo dirto. Tirakoobka (GA4) iyo Crisp Chat waxaa lagu habeeyaa dano sharci ah oo la xiriira maamulka iyo horumarinta bogga. Waxaad ka diidi kartaa labadaba adiga oo adeegsanaya ogeysiiska cookies-ka." },
      ...
      { title: "Xuquuqdaada", body: <>Waxaad xaq u leedahay inaad codsato inaad aragto, saxdo ama tirtirto xogta aan kaa hayno. Waxa kale oo aad xaq u leedahay inaad ka soo horjeedsato habaynta xogtaada. Si aad u isticmaasho xuquuqdaada, kala xiriir {MAIL}.<br /><br />Waxaad sidoo kale cabasho u gudbin kartaa Datatilsynet adiga oo booqanaya {DT_DA}.</> },
      { title: "Xiriir", body: <>Haddii aad qabto wax su'aalo ah oo ku saabsan habaynta xogtaada shakhsiga, waxaad nagala soo xiriiri kartaa adeegga wada sheekaysiga (chat-ka) ee bogga ama email-ka: {MAIL}.</> },
    ],
  },
  ar: {
